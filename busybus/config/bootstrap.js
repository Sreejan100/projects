...
module.exports.bootstrap = async function() {
  ...
  await Ticket.createEach([
    {name:'Ryan Dahl', emailAddress:'admin@example.com',source:'Kolkata',destination:'Mumbai',journey_date:'11-4-2020',departure_time:'2:00pm',age:'20',contactno:'9087654321'},
  ]);
